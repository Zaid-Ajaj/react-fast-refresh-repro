...
function truncate(count$$4, array$$11) {
  var count$$5 = (0, _Util.max)(_Util.comparePrimitives, 0, count$$4) | 0;
...
function distinctBy(projection$$1, array$$17, eq$$1) {
  var hashSet = (0, _Set.createMutable)([], eq$$1);
...
function except(itemsToExclude, array$$23, eq$$4) {
  if (array$$23.length === 0) {
    ...
    var cached = (0, _Set.createMutable)(itemsToExclude, eq$$4);
...
function groupBy(projection$$2, array$$26, cons$$11, eq$$5) {
  ...
  for (var idx$$3 = 0; idx$$3 <= array$$26.length - 1; idx$$3++) {
    ...
    var matchValue$$4 = (0, _Util.tryGetValue)(dict$$1, key$$2, null);
...
function find(predicate$$11, array$$59) {
  ...
  if (matchValue$$5 == null) {
    ...
    var res$$4 = (0, _Option.value)(matchValue$$5);
    return res$$4;
  }
}
...
function setSlice(target$$5, lower, upper, source$$5) {
  ...
  var upper$$1 = (0, _Option.defaultArg)(upper, 0) | 0;
...
function windowed(windowSize, source$$9) {
  ...
  var res$$9;
  var len$$18 = (0, _Util.max)(_Util.comparePrimitives, 0, source$$9.length - windowSize) | 0;
...
function splitInto(chunks, array$$124) {
  ...
  if (array$$124.length === 0) {
    ...
    var result$$14 = [];
    var chunks$$1 = (0, _Util.min)(_Util.comparePrimitives, chunks, array$$124.length) | 0;
    ...
    for (var i$$50 = 0; i$$50 <= chunks$$1 - 1; i$$50++) {
      ...
      var start$$11 = i$$50 * minChunkSize + (0, _Util.min)(_Util.comparePrimitives, chunksWithExtraItem, i$$50) | 0;
