...
var MutableSet$00601 = (0, _Types.declare)(function Fable_Collections_MutableSet(items, comparer) {
  var $this$$1 = this;
...
function MutableSet$00601$$Add$$2B595(this$$$6, k$$2) {
  ...
  switch ($target$$16) {
    ...
    case 1:
      {
        if (matchValue$$2[0]) {
          var value$$1 = void (0, _Util.getItemFromDict)(this$$$6.hashMap, matchValue$$2[1]).push(k$$2);
          void null;
          return true;
        } else {
