...
var SetTree$00601 = (0, _Types.declare)(function Set_SetTree(tag, name) {
  this.tag = tag | 0;
  this.name = name;
...
function SetTree$00601$reflection($gen$$3) {
  return (0, _Reflection.union_type)("Set.SetTree`1", [$gen$$3], SetTree$00601, function () {
    return ["SetEmpty", ["SetNode", [["Item1", $gen$$3], ["Item2", SetTree$00601$reflection($gen$$3)], ["Item3", SetTree$00601$reflection($gen$$3)], ["Item4", _Reflection.int32_type]]], ["SetOne", [["Item", $gen$$3]]]];
  });
}
...
function SetTreeModule$$$minimumElement(s$$11) {
  ...
  if (matchValue$$4 == null) {
    ...
    var k$$27 = (0, _Option.value)(matchValue$$4);
    return k$$27;
  }
}
...
function SetTreeModule$$$maximumElement(s$$12) {
  ...
  if (matchValue$$5 == null) {
    ...
    var k$$28 = (0, _Option.value)(matchValue$$5);
    return k$$28;
  }
}

var SetTreeModule$002ESetIterator$00601 = (0, _Types.declare)(function Set_SetTreeModule_SetIterator(stack, started) {
  this.stack = stack;
...
function SetTreeModule$002ESetIterator$00601$reflection($gen$$103) {
  return (0, _Reflection.record_type)("Set.SetTreeModule.SetIterator`1", [$gen$$103], SetTreeModule$002ESetIterator$00601, function () {
    return [["stack", (0, _Reflection.list_type)(SetTree$00601$reflection($gen$$103))], ["started", _Reflection.bool_type]];
  });
}
...
var SetTreeModule$002EmkIEnumerator$00601 = (0, _Types.declare)(function Set_SetTreeModule_mkIEnumerator(s$$14) {
  var $this$$1 = this;
  $this$$1.s = s$$14;
...
function SetTreeModule$$$ofSeq(comparer$$20, c$$11) {
  var ie = (0, _Seq.getEnumerator)(c$$11);
...
var FSharpSet = (0, _Types.declare)(function Set_Set(comparer$$22, tree) {
  var $this$$2 = this;
...
FSharpSet.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    var x$$22 = res | 0;
    var y$$4 = (0, _Util.structuralHash)(e$$1.Current) | 0;
    res = (x$$22 << 1) + y$$4 + 631;
  }
...
function createMutable(source, comparer$$31) {
  var set = (0, _MutableSet.MutableSet$00601$$$$002Ector$$Z6150332D)(source, comparer$$31);
  return set;
}

function distinct(xs, comparer$$32) {
  return (0, _Seq.delay)(function () {
    var set$$1 = (0, _MutableSet.MutableSet$00601$$$$002Ector$$Z6150332D)((0, _Seq.empty)(), comparer$$32);
...
function distinctBy(projection, xs$$1, comparer$$33) {
  return (0, _Seq.delay)(function () {
    var set$$2 = (0, _MutableSet.MutableSet$00601$$$$002Ector$$Z6150332D)((0, _Seq.empty)(), comparer$$33);
