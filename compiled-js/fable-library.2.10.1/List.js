...
function ofSeq(xs$$12) {
  var xs$$13 = (0, _Seq.fold)(function (acc$$3, x$$9) {
...
function concat(lists) {
  var xs$$15 = (0, _Seq.fold)(function (state$$3, xs$$14) {
...
function scan(f$$13, state$$11, xs$$23) {
  var xs$$24 = (0, _Seq.scan)(f$$13, state$$11, xs$$23);
  return ofSeq(xs$$24);
}

function scanBack(f$$14, xs$$25, state$$12) {
  var xs$$26 = (0, _Seq.scanBack)(f$$14, xs$$25, state$$12);
  return ofSeq(xs$$26);
}
...
function collect(f$$15, xs$$29) {
  var xs$$30 = (0, _Seq.collect)(f$$15, xs$$29);
  return ofSeq(xs$$30);
}
...
function ofArray(xs$$50) {
  var res$$1 = new _Types.List();

  for (var i$$9 = (0, _Util.count)(xs$$50) - 1; i$$9 >= 0; i$$9--) {
...
function pick(f$$31, xs$$54) {
  ...
  if (matchValue$$5 != null) {
    var x$$30 = (0, _Option.value)(matchValue$$5);
    return x$$30;
  } else {
...
function findIndexed(f$$34, xs$$57) {
  ...
  if (matchValue$$6 != null) {
    var x$$33 = (0, _Option.value)(matchValue$$6);
    return x$$33;
  } else {
    throw new Error("List did not contain any matching elements");
  }
...
function tryFindIndexBack(f$$39, xs$$66) {
  var array = (0, _Array.ofList)(xs$$66, Array);
...
function findIndexBack(f$$41, xs$$68) {
  var array$$1 = (0, _Array.ofList)(xs$$68, Array);
...
function choose(f$$44, xs$$74) {
  var xs$$75 = fold(function (acc$$18, x$$39) {
    ...
    if (matchValue$$8 == null) {
      ...
      var y$$10 = (0, _Option.value)(matchValue$$8);
...
function except(itemsToExclude, array$$2, eq$$1) {
  if (isEmpty(array$$2)) {
    ...
    var cached = (0, _Set.createMutable)(itemsToExclude, eq$$1);
...
function sort(xs$$87, comparer$$1) {
  var xs$$89;
  var xs$$88 = (0, _Array.ofList)(xs$$87, Array);
...
function sortBy(projection, xs$$90, comparer$$3) {
  var xs$$92;
  var xs$$91 = (0, _Array.ofList)(xs$$90, Array);
...
function sortDescending(xs$$93, comparer$$5) {
  var xs$$95;
  var xs$$94 = (0, _Array.ofList)(xs$$93, Array);
...
function sortByDescending(projection$$1, xs$$96, comparer$$7) {
  var xs$$98;
  var xs$$97 = (0, _Array.ofList)(xs$$96, Array);
...
function sortWith(comparer$$9, xs$$99) {
  var xs$$101;
  var xs$$100 = (0, _Array.ofList)(xs$$99, Array);
...
function take(i$$22, xs$$123) {
  if (i$$22 < 0) {
    ...
    switch ($target$$252) {
      ...
      case 2:
        {
          var tuple = takeSplitAux(true, i$$25, new _Types.List(), xs$$124);
          return tuple[0];
        }
    }
  }
...
function truncate(i$$26, xs$$127) {
  if (i$$26 < 0) {
    ...
    switch ($target$$257) {
      ...
      case 2:
        {
          var tuple$$1 = takeSplitAux(false, i$$29, new _Types.List(), xs$$128);
          return tuple$$1[0];
        }
    }
  }
...
function slice(lower, upper, xs$$132) {
  var lower$$1 = (0, _Option.defaultArg)(lower, 0) | 0;
...
function distinctBy(projection$$4, xs$$134, eq$$2) {
  var hashSet = (0, _Set.createMutable)([], eq$$2);
...
function groupBy(projection$$5, xs$$139, eq$$4) {
  var dict = (0, _Map.createMutable)([], eq$$4);
  var keys = new _Types.List();
  iterate(function f$$59(v$$2) {
    var key = projection$$5(v$$2);
    var matchValue$$16 = (0, _Util.tryGetValue)(dict, key, null);
...
function countBy(projection$$6, xs$$142, eq$$5) {
  var dict$$1 = (0, _Map.createMutable)([], eq$$5);
  var keys$$1 = new _Types.List();
  iterate(function f$$61(v$$3) {
    var key$$2 = projection$$6(v$$3);
    var matchValue$$17 = (0, _Util.tryGetValue)(dict$$1, key$$2, 0);
...
function pairwise(source$$1) {
  var xs$$145 = (0, _Seq.pairwise)(source$$1);
  return ofSeq(xs$$145);
}
