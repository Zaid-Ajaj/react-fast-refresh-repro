...
var MapTree$00602 = (0, _Types.declare)(function Map_MapTree(tag, name) {
  this.tag = tag | 0;
  this.name = name;
...
function MapTree$00602$reflection($gen$$3, $gen$$4) {
  return (0, _Reflection.union_type)("Map.MapTree`2", [$gen$$3, $gen$$4], MapTree$00602, function () {
    return ["MapEmpty", ["MapOne", [["Item1", $gen$$3], ["Item2", $gen$$4]]], ["MapNode", [["Item1", $gen$$3], ["Item2", $gen$$4], ["Item3", MapTree$00602$reflection($gen$$3, $gen$$4)], ["Item4", MapTree$00602$reflection($gen$$3, $gen$$4)], ["Item5", _Reflection.int32_type]]]];
  });
}
...
function MapTreeModule$$$ofSeq(comparer$$16, c$$9) {
  var ie = (0, _Seq.getEnumerator)(c$$9);
...
var MapTreeModule$002EMapIterator$00602 = (0, _Types.declare)(function Map_MapTreeModule_MapIterator(stack, started) {
  this.stack = stack;
...
function MapTreeModule$002EMapIterator$00602$reflection($gen$$109, $gen$$110) {
  return (0, _Reflection.record_type)("Map.MapTreeModule.MapIterator`2", [$gen$$109, $gen$$110], MapTreeModule$002EMapIterator$00602, function () {
    return [["stack", (0, _Reflection.list_type)(MapTree$00602$reflection($gen$$109, $gen$$110))], ["started", _Reflection.bool_type]];
  });
}
...
var MapTreeModule$002EmkIEnumerator$0027$00602 = (0, _Types.declare)(function Map_MapTreeModule_mkIEnumerator_(s$$6) {
  var $this$$1 = this;
  $this$$1.s = s$$6;
...
var FSharpMap = (0, _Types.declare)(function Map_Map(comparer$$17, tree) {
  var $this$$2 = this;
...
function FSharpMap$$TryGetValue$$5BDDA1(__$$9, k$$30, defValue) {
  ...
  if (matchValue$$6 == null) {
    ...
    var v$$25 = (0, _Option.value)(matchValue$$6);
    return [true, v$$25];
  }
}
...
function pick(f$$29, m$$31) {
  ...
  if (matchValue$$8 != null) {
    var res$$5 = (0, _Option.value)(matchValue$$8);
    return res$$5;
  } else {
    throw new Error("key not found");
  }
...
function findKey(f$$38, m$$41) {
  ...
  if (_arg1$$2 == null) {
    ...
    var k$$43 = (0, _Option.value)(_arg1$$2);
    return k$$43;
  }
}
...
function createMutable(source$$3, comparer$$22) {
  var map$$1 = (0, _MutableMap.MutableMap$00602$$$$002Ector$$6623D9B3)(source$$3, comparer$$22);
  return map$$1;
}

function groupBy(projection, xs, comparer$$23) {
  var dict = createMutable((0, _Seq.empty)(), comparer$$23);
...
function countBy(projection$$1, xs$$1, comparer$$24) {
  var dict$$1 = createMutable((0, _Seq.empty)(), comparer$$24);
